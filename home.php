...
<html lang="fr">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href=""><i class="bi bi-house-fill"></i> Acceuil</a>
                  </li>
                  <li class="nav-item">
          ...
          <!-- Navigation Bar -->
          <!-- Les informations de base du site -->
          <div class="card, p-3 mb-2 text-black">
            <div class="card-body">
              <img src="../assets/Logo.png"class="card-img-top-lg" alt="...">
              <h5 class="card-title">Vaxy Dev</h5>
              <p class="card-text">C'est un podcast créé sur <strong>YouTube</strong> par Gaël Hébert-Furoy le 20 mai 2023. Gaël a invité Matéo Sweeney et Mathieu Merrit au projet. Gaël a ensuite eu l'idée d'aider les gens en créent un site internet où il peuvent demander des l'aide pour les erreurs dans leurs codes.</p>
              <a href="https://youtube.com/@VaxyDev" class="btn btn-danger"><i class="bi bi-youtube"></i> Chaîne YouTube</a>
            </div>
